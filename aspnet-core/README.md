...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f316166d-15e8-43ec-b3a6-273f2412a071
```

> `f316166d-15e8-43ec-b3a6-273f2412a071` is the password of the certificate, you can change it to any password you want.
...
Run `TaskFlow.DbMigrator` to create the initial database. This should be done in the first run. It is also needed if a new database migration is added to the solution later.

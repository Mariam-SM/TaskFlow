...
namespace TaskFlow.Migrations
{
    ...
    [Migration("20260607132205_AddedTaskEmbeddings")]
    partial class AddedTaskEmbeddings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Entities.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("TaskFlow.Entities.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskFlow.Entities.TaskItems.TaskItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EmbeddingSerialized")
                        .IsRequired()
            ...
            modelBuilder.Entity("TaskFlow.Entities.Comments.Comment", b =>
                {
                    b.HasOne("TaskFlow.Entities.TaskItems.TaskItem", "Task")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TaskFlow.Entities.TaskItems.TaskItem", b =>
                {
                    b.HasOne("TaskFlow.Entities.Projects.Project", "Project")
                        .WithMany("Tasks")
